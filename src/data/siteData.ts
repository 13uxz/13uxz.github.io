...
export const siteData = {
  ...
  bio: [
    ...
    "Having recently returned to London, 13uxz's first performances have included Notting Hill Arts Club, with brunch sets coming up at Aki London. A versatile DJ, he brings extensive experience collaborating with live percussionists and saxophonists, seamlessly integrating live elements into his sets. Career highlights include entertaining 25,000 people during the Dubai Shopping Festival on New Year's Eve, performing at the techno event Modulate at KYO on the Palm, and appearing at Sounds by Laya / Sounds by AKS events. His mixes have been featured on BeatFM as part of a weekly show.",
  ],
