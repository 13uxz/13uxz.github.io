      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-[11px]">
          ...
          >
            ...
            <span className="uppercase tracking-[0.15em]">Email</span>
          </a>
          <span className="text-accent/30">&copy; {new Date().getFullYear()} 13uxz</span>
          <a
          ...
          >
            ...
            <span className="uppercase tracking-[0.15em]">WhatsApp</span>
          </a>
        </div>
      </div>
    </footer>
